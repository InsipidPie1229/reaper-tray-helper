...
Copy-Item -LiteralPath (Join-Path $Artifacts "$appName.exe"), (Join-Path $Root 'ReaperTrayHelper_ToggleTrackMute.lua'), (Join-Path $Root 'README.md'), (Join-Path $Root 'README.ko.md'), (Join-Path $Root 'LICENSE') -Destination $releaseRoot
Copy-Item -LiteralPath (Join-Path $Root '.github'), (Join-Path $Root 'src'), (Join-Path $Root 'tests'), (Join-Path $Root 'scripts'), (Join-Path $Root 'ReaperTrayHelper_ToggleTrackMute.lua'), (Join-Path $Root 'README.md'), (Join-Path $Root 'README.ko.md'), (Join-Path $Root 'LICENSE'), (Join-Path $Root 'SECURITY.md'), (Join-Path $Root 'TESTING.md'), (Join-Path $Root 'THIRD_PARTY_NOTICES.md'), (Join-Path $Root 'build.cmd') -Destination $sourceRoot -Recurse
